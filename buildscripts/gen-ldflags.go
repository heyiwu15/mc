...
func genLDFlags(version string) string {
	...
	ldflagsStr = "-s -w -X github.com/heyiwu15/mc/cmd.Version=" + version + " "
	ldflagsStr = ldflagsStr + "-X github.com/heyiwu15/mc/cmd.CopyrightYear=" + copyrightYear + " "
	ldflagsStr = ldflagsStr + "-X github.com/heyiwu15/mc/cmd.ReleaseTag=" + releaseTag + " "
	ldflagsStr = ldflagsStr + "-X github.com/heyiwu15/mc/cmd.CommitID=" + commitID() + " "
	ldflagsStr = ldflagsStr + "-X github.com/heyiwu15/mc/cmd.ShortCommitID=" + commitID()[:12]
	return ldflagsStr
}
